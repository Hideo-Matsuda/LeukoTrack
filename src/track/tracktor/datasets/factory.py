...
from .mot_wrapper import (MOT17LOWFPSWrapper, MOT17PrivateWrapper,
                          MOT17Wrapper, MOT19Wrapper, MOT20Wrapper, BiodataWrapper)
...
# Edit code by imitating this code. (if you want to suit for original evaluation method)
for split in['all','group0', 'group1']:
    name = f'biodata_{split}'
    _sets[name] = (lambda *args, split=split: BiodataWrapper(split, *args))
