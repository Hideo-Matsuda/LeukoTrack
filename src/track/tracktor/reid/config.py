...
def get_default_config():
    ...
    cfg.data.height = 512 # image height
    cfg.data.width = 512 # image width
    ...
    cfg.crest = CN()
    cfg.crest.num_per_id_query = 5
    cfg.crest.num_per_id_gallery = 1
    cfg.crest.min_vis = 0.0
    cfg.crest.min_h = 5
    cfg.crest.min_w = 5
    cfg.crest.min_samples = 10
    cfg.crest.sample_nth_frame = 0
