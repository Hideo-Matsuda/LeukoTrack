...
class MOTSeqDataset(ImageDataset):
    ...
    def __init__(self, seq_name, cfg, **kwargs):
        ...
        query_per_id = sample_random_per_reid_id(df, cfg.crest.num_per_id_query)
        ...
        gallery_per_id = sample_random_per_reid_id(gallery_df, cfg.crest.num_per_id_gallery)
...
class MOTSeqDeIDDataset(MOTSeqDataset):
    def __init__(self, seq_name, cfg, **kwargs):
        ...
        query_per_reid_id = sample_random_per_reid_id(df_sources, cfg.crest.num_per_id_query)
        ...
        gallery_per_reid_id = sample_random_per_reid_id(df_sources, cfg.crest.num_per_id_gallery)
