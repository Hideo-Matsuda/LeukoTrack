...
ex = Experiment()
ARG_CONFIG_FILE = 'cfg_file'
parser = argparse.ArgumentParser()
parser.add_argument(f'-{ARG_CONFIG_FILE[0]}', f'--{ARG_CONFIG_FILE}', required=True, type=str)
args = vars(parser.parse_args())
ex.add_config(args[ARG_CONFIG_FILE])
...
def main(module_name, name, seed, obj_detect_models, reid_models,
    ...
    if mot_accums:
        ...
        evaluate_mot_accums(output_dir, mot_accums,
